...
class SalesOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sales_order" do
    assert_difference("SalesOrder.count") do
      post sales_orders_url, params: { sales_order: { client_id: @sales_order.client_id, order_date: @sales_order.order_date, total_amount: @sales_order.total_amount, user_id: @sales_order.user_id } }
    end
  ...
  test "should update sales_order" do
    patch sales_order_url(@sales_order), params: { sales_order: { client_id: @sales_order.client_id, order_date: @sales_order.order_date, total_amount: @sales_order.total_amount, user_id: @sales_order.user_id } }
